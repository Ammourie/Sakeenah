...
class Validators {
  ...
  static final RegExp _passwordRegExp = RegExp(r'^.{5,30}$');
  ...
  ///
  /// This validator is used when a text field is required.
  ///
  static String? requiredField(String? val) {
    if (val?.isNotEmpty ?? false) return null;
  ...
  ///
  static String? requiredFieldWithMessage(String? val, String message) {
    if (val?.isNotEmpty ?? false) return null;
    return message;
  }
}
