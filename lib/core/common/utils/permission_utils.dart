...
class RequestPermissionsParam {
  final PermissionOption calendarFullAccess;
  final PermissionOption calendarWriteOnly;
  ...
  const RequestPermissionsParam({
    this.calendarFullAccess = PermissionOption.NoPermission,
    this.calendarWriteOnly = PermissionOption.NoPermission,
