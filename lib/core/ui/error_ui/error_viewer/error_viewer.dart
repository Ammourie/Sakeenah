...
import '../../dialogs/guest_dialog.dart';
...
class ErrorViewer {
  ...
  static void showCustomError(
    ...
    if (errorViewerOptions is ErrVSnackBarOptions) {
      ...
      showErrorToast(message: message, errVToastOptions: errorViewerOptions);
    } else if (errorViewerOptions is ErrVDialogOptions) {
      showCustomErrorDialog(
        context: context,
        message: message,
  ...
  static void showGuestError({
    ...
    if (errorViewerOptions is ErrVDialogOptions) {
      ...
      showErrorToast(
        message: S.current.guetsMessage,
        errVToastOptions: errorViewerOptions,
      );
    } else if (errorViewerOptions is ErrVSnackBarOptions) {
      showErrorSnackBar(
        message: S.current.guetsMessage,
        errVSnackBarOptions: errorViewerOptions,
      );
