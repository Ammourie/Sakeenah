  ...
  ShowDialog().showElasticDialog(
    ...
    builder: (BuildContext context) {
      return LanguageDialog(
        initialValue: mapStringToLanguagesEnum(
...
class LanguageDialog extends StatefulWidget {
  const LanguageDialog({required this.initialValue});
                    ...
                    onPressed: () async {
                      ...
                      switch (this._selectedId) {
                        case 0:
                          changeLanguage(
                            context,
                            const Locale(AppConstants.LANG_EN),
                          );
                        ...
                        case 1:
                          changeLanguage(
                            context,
                            const Locale(AppConstants.LANG_AR),
                          );
                          // await Provider.of<AppConfigProvider>(context,
                          //         listen: false)
                        ...
                        case 2:
                          changeLanguage(
                            context,
                            const Locale(AppConstants.LANG_KU),
                          );
                      }
                      // Navigator.of(context).pop();
                      Nav.pop();
